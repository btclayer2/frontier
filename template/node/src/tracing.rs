...
use crate::{
	eth::{EthApi as EthApiCmd, EthConfiguration as RpcConfig},
	rpc::TracingSpawnTasksParams,
};
...
pub fn spawn_tracing_tasks<B, C, BE>(
	...
	params: TracingSpawnTasksParams<B, C, BE>,
) -> RpcRequesters
where
	...
	C: Send + Sync + 'static,
	C::Api: EthereumRuntimeRPCApi<B> + fp_rpc_debug::DebugRuntimeApi<B> + fp_rpc_txpool::TxPoolRuntimeApi<B>,
